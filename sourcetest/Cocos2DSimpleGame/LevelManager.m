...
- (id)init {
    if ((self = [super init])) {
        ...
        Level * level3 = [[[Level alloc] initWithLevelNum:3 secsPerSpawn:0.8f backgroundColor:ccc4(20, 80, 20, 255)] autorelease];
        Level * level4 = [[[Level alloc] initWithLevelNum:4 secsPerSpawn:0.6f backgroundColor:ccc4(150, 30, 20, 255)] autorelease];
